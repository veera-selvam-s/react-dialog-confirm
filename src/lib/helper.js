    ...
    case "warning":
      return (
        ...
        >
          ...
          />
          <path
            d="M-197.4-236.1h2.8v2.8h-2.8zM-195.2-238.9h-1.6l-.6-11.3v-8.5h2.8v8.5l-.6 11.3"
            transform="translate(228 278)"
            fill="#eab308"
            className="fill-134563"
          />
    ...
    case "info":
      return (
        ...
        >
          ...
          {/* eslint-disable-next-line max-len */}
          <path
            d="M23.779 16.241c-.216 0-.357-.144-.357-.359v-2.618c0-.215.142-.359.357-.359h2.439c.215 0 .359.144.359.359v2.618c0 .215-.145.359-.359.359h-2.439zm.073 21.052c-.215 0-.358-.143-.358-.358V20.473c0-.215.144-.359.358-.359h2.295c.216 0 .359.144.359.359v16.462c0 .216-.144.358-.359.358h-2.295z"
            fill="#0ea5df"
            className="fill-000000"
          ></path>
        </svg>
