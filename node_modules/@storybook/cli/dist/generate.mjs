...
For more information visit:`,chalk23.cyan("https://storybook.js.org")),projectType==="ANGULAR"?(logger19.log(`
To run your Storybook, type:
`),codeLog([`ng run ${installResult.projectName}:storybook`])):projectType==="REACT_NATIVE"?(logger19.log(),logger19.log(chalk23.yellow(`NOTE: installation is not 100% automated.
...
`),logger19.log(chalk23.cyan("https://github.com/storybookjs/react-native")),logger19.log()):(logger19.log(`
To run your Storybook, type:
...
`)}
            `.trim(),{borderStyle:"round",padding:1,borderColor:"#F1618C"})),process.exit(1)),choices.length===1?[selectedTemplate]=choices:(logger23.info(boxen2(dedent27`
            🤗 Welcome to ${chalk24.yellow("sb sandbox")}! 🤗
